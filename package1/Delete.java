...
public class Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Transtech University-Delete");
        ...
        deleteButton.setBackground(new java.awt.Color(166, 64, 64));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 440, 100, 40));
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, -1, -1));
        ...
        if (answer == JOptionPane.YES_OPTION) {
            try {
                ...
                st.executeUpdate("UPDATE reg_tbl SET  fname= '" + textName.getText()
                        ...
                        + "',birthday= '" + ((JTextField) textBirthday.getDateEditor().getUiComponent()).getText()
